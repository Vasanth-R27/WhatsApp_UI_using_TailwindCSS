...
function executeCommand(command, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var childProcess, versionInfo, error;
...
function getPackageVersions(names) {
    var _this = this;
    var versionInfo = {};
    if (!names || !names.length) {
        throw "Please specify at least 1 package";
    }
    var promises = names.map(function (pkg) { return __awaiter(_this, void 0, void 0, function () {
        var version;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, executeCommand("npm view " + pkg + " version json")];
                case 1:
                    version = _a.sent();
                    if (version) {
